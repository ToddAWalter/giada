...
public:
	/* Result
	Reports how many input frames were consumed and how many output frames were
	generated by a single call to process(). */
	...
	Result process(const float* input, std::size_t inputLength,
